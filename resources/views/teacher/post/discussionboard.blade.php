    ...
    <div class="profile-page">
        <div class="profile-page-part1">
            <div class="side-menu-list">
                <a href="{{ route('teacher.post.create') }}" class="side-menu-list-item side-menu-list-item-action">Create New Discussion</a>
        ...
        <div class="profile-page-part2">
            <div class="profile-display">
                ...
                @else
                    {{-- <a href="{{ route('post.create') }}" class="btn btn-primary mb-3">Add New Discussion Topic</a> --}}
                    @foreach ($posts as $post)
                        <div class="discussion-board-inside-box">
                            <div class="board-part1">
                                ...
                                <div class="board-part1-2">
                                    <a href="{{ route('post.edit', ['id' => $post->id]) }}" class="btn btn-warning"
                                        style="background-color: #ddddf4; border:none;">Edit</a>
                                    <form action="{{ route('post.destroy', ['id' => $post->id]) }}" method="POST"
                                        style="display:inline; background-color: #f4e3dd; border:none;">
                                        @csrf
                                        @method('DELETE')
