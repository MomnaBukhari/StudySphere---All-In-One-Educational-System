...
@section('section1')
    <div class="profile-page">
        <div class="profile-page-part1">
            ...
            <div class="side-menu-list">
                <a href="{{ route('student.profile') }}" class="side-menu-list-item side-menu-list-item-action">Show
                    Profile</a>
                ...
                <form action="{{ route('guardian.deleteaccount') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete your account? This action cannot be undone.');">
                    @csrf
                ...
                <section id="show-profile">
                    ...
                    <div class="show_profile_info">
                        ...
                        <table>
                            ...
                            <tr>
                                <th>CNIC: </th>
                                <td>{{ $user->cnic ?? 'Not Set Yet' }}</td>
                            </tr>

                            <tr>
                                <th>Gender: </th>
                                <td>{{ $user->gender ?? 'Not Set Yet' }}</td>
                            </tr>
    ...
    @endif-->
                    ...
                    <form id="edit-profile-form" action="{{ route('guardian.profile.store') }}" method="POST"
                        ...
                        {{-- <button type="button" onclick="window.location.href='/student/profile'"
                ...
                <section id="privacy-settings" style="display: none;">
                    ...
                    <form action="{{ route('student.profile.updatePrivacy') }}" method="POST">
                        @csrf
    ...
    <script>
        ...
        function confirmBack() {
            if (confirm('Are you sure you want to go back? Any unsaved changes will be lost.')) {
                window.location.href = '/guardian_profile';
            }
        }
    </script>
@endsection
